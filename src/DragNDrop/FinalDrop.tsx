...
//             <DroppableArea onDrop={handleRow} title='ROW' droppedItems={selectedRow}/>
//             <DroppableArea onDrop={handleColumn} title='COLUMNS' droppedItems={selectedColumn}/>
//             <DroppableArea onDrop={handleValue} title='VALUES' droppedItems={selectedValue}/>
//             {/* <div>
//                 <h3>Dropped Items:</h3>
//                 <ul>
